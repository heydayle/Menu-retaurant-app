...
export const menu = [
  {
    ...
    static: true,
    products: [
      { id: "cf1", name: "Phê Đen", price: 10000, process: "2" },
      { id: "cf2", name: "Phê Sữa", price: 12000, process: "2" },
      { id: "cf3", name: "Bạc xỉu", price: 12000, process: "1" },
      { id: "cf4", name: "Espresso", price: 14000, process: "1" },
      { id: "cf5", name: "Cold Brew", price: 16000, process: "1" },
      { id: "cf6", name: "CaCao", price: 14000, process: "2" },
    ],
  },
  {
    x: 2,
    ...
    static: true,
    products: [
      { id: "tea1", name: "Trà Đường", price: 10000, process: "1" },
      { id: "tea2", name: "Trà Sữa", price: 14000, process: "1" },
      { id: "tea3", name: "Trà Chanh", price: 12000, process: "2" },
      { id: "tea4", name: "Lipton", price: 14000, process: "2" },
      { id: "tea5", name: "Lipton Sữa", price: 16000, process: "2" },
    ],
  },
  {
    x: 4,
    ...
    static: false,
    products: [
      { id: "jui1", name: "Cam vắt", price: 16000, process: "1" },
      { id: "jui2", name: "Mũ gòn", price: 12000, process: "1" },
      { id: "jui3", name: "Mũ gòn sữa", price: 14000, process: "1" },
      { id: "jui4", name: "Rau má", price: 12000, process: "1" },
      { id: "jui5", name: "Rau má đậu", price: 14000, process: "1" },
      { id: "jui6", name: "Rau má dừa", price: 16000, process: "1" },
      { id: "jui7", name: "Dừa tươi", price: 14000, process: "1" },
      { id: "jui8", name: "Dưa hấu", price: 16000, process: "1" },
      { id: "jui9", name: "Xoài", price: 16000, process: "1" },
      { id: "jui10", name: "Cóc", price: 16000, process: "1" },
      { id: "jui11", name: "Ổi", price: 16000, process: "1" },
      { id: "jui12", name: "Lựu", price: 16000, process: "1" },
    ],
  },
  {
    x: 6,
